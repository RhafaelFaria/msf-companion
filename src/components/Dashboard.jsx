          ...
          <div className="space-y-2">
            {tasks.map(task => (
              <div 
                ...
                className={`flex items-center justify-between p-3 rounded border cursor-pointer select-none transition-all gap-3 ${
                  task.done 
              ...
              >
                ...
                <span className={`text-[10px] font-bold uppercase tracking-widest px-2 py-0.5 rounded shrink-0 ${
        ...
        <div className="space-y-6">
          <div className="bg-gray-950 border border-emerald-500/20 rounded p-5 shadow-[0_0_15px_rgba(16,185,129,0.05)]">
            ...
            <div className="space-y-3">
              <div className="bg-slate-900 p-3 rounded border border-slate-800 flex justify-between items-center gap-3">
                <div>
