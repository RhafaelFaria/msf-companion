      ...
      <header className="bg-gray-950 border-b border-cyan-500 shadow-[0_0_15px_rgba(6,182,212,0.4)] sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center space-x-3">
            <div className="w-10 h-10 bg-gradient-to-br from-cyan-400 to-blue-600 rounded-sm transform rotate-45 border border-cyan-200 flex items-center justify-center">
          ...
          <nav className="space-x-6 uppercase text-sm font-bold tracking-widest">
            <button 
